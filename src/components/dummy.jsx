...
//             <label
//               htmlFor="sortBy"
//               className="text-base leading-[30px] text-[#767676]"
//             >
//               Sort by:
//             </label>
//             <select
//               name=""
//               id="sortBy"
//               className="py-1 px-5 outline-none border border-[#F0F0F0] text-base leading-[30px] text-[#767676]"
//             >
...
//         <div className="">
//           <span className="text-base font-normal leading-8 text-[#767676]">
//             Products from {itemOffset + 1} to{" "}
//             {endOffset > DummyProduct.length ? DummyProduct.length : endOffset}{" "}
//             of {DummyProduct.length}
//           </span>
//         </div>
//       </div>
//     </>
